...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2"><span class="style7"><span class="style23">Friend Requests To</span> <span class="style23">::</span><span class="style21"> <%=session.getAttribute("uname") %></span></span></h2>
          <p class="infopost">&nbsp;</p>
